...
![](../output/measurement_gap.svg)

<figure>
  <img src="../output/measurement_gap.svg" alt="The Measurement Gap: Number of organisations by registration/coverage type. Bar chart showing difference between registered charities, WCVA members, total active orgs, and Baromedr respondents">
...
![](../output/wcva_wg_funding.svg)

<figure>
  <img src="../output/wcva_wg_funding.svg" alt="Welsh Government payments to WCVA by grants and contracts 2021-2025. Stacked bar chart showing grant and contract payments from Welsh Government to WCVA over four financial years.">
...
![](../output/nlcf_wales.svg)

<figure>
  <img src="../output/nlcf_wales.svg" alt="National Lottery Community Fund grants to Wales. Bar chart showing NLCF grants to Wales in recent years.">
...
![](../output/funding_flows.svg)

<figure>
  <img src="../output/funding_flows.svg" alt="Estimated annual public funding flows into the Welsh voluntary sector. Horizontal bar chart showing major funding sources">
...
![](../output/sroi_comparison.svg)

<figure>
  <img src="../output/sroi_comparison.svg" alt="SROI ratios from Wales-based studies showing £ return per £1 invested. Stacked horizontal bar chart comparing SROI ratios across different Welsh voluntary sector programmes">
...
![](../output/volunteering_value.svg)

<figure>
  <img src="../output/volunteering_value.svg" alt="Economic value of volunteering and unpaid care in billions of pounds. Bar chart showing different valuations of volunteering and unpaid care">
...
![](../output/alignment_heatmap.svg)

<figure>
  <img src="../output/alignment_heatmap.svg" alt="Heatmap showing alignment strength between New Approach enablers and objectives, supported by SROI evidence. Heatmap matrix mapping New Approach to Volunteering framework enablers against objectives with SROI evidence strength ratings">
...
![](../output/framework_flow.svg)

<figure>
  <img src="../output/framework_flow.svg" alt="New Approach framework flow: Enablers - Objectives - Vision, with SROI data points (Plotly version). Plotly flowchart showing how the New Approach to Volunteering framework connects enablers through objectives to the vision, annotated with key SROI figures from the evidence base">
...
<figure>
  <img src="../output/timeline.svg" alt="Implementation timeline for the New Approach to Volunteering in Wales. Gantt-style horizontal bar chart showing implementation phases and their durations from July 2025 launch">
